      ...
      {open && (
        ...
        >
          <motion.div
            ...
            className="relative max-w-xl rounded-2xl border border-(--primary)/30 bg-(--background)/95 backdrop-blur-2xl shadow-2xl p-8 sm:p-10 text-center"
          ...
          >
            ...
            <motion.div
              ...
              className="mx-auto w-14 h-14 rounded-full flex items-center justify-center mb-5 border border-(--primary)/40"
              style={{
            ...
            <button
              onClick={onEnter}
              className="inline-flex items-center gap-2 px-5 py-2.5 rounded-full bg-primary text-primary-foreground font-mono text-xs uppercase tracking-[0.25em] hover:scale-[1.03] transition-transform"
...
export function StardustChip({ onExit }: StardustChipProps) {
  ...
  return (
    <motion.button
      ...
      exit={{ opacity: 0, y: -8 }}
      onClick={onExit}
      className="flex items-center gap-2 px-3 py-1.5 rounded-full border border-(--primary)/60 bg-(--primary)/15 text-primary font-mono text-[10px] uppercase tracking-[0.25em] hover:bg-(--primary)/25 transition-colors"
